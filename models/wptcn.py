...
class WPTCN(nn.Module):
    def __init__(self, num_input_channels, input_length, num_classes, hidden_dim, kernel_size, num_levels, num_layers, wavelet_type, feedforward_ratio, group_type, normalization_eps=1e-5, normalization_affine=True):
        ...
        self.fc = nn.Linear(hidden_dim, num_classes)  # 修改为 num_classes
